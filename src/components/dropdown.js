...
const Dropdown=(props)=>{
    ...
    const DropdownItem=(props)=>{
        ...
        return(<div className="drop-item">
                    ...
                    <button className='dropdown-btn' name={props.name} id={props.src} title={props.price} onClick={Add}> <FontAwesomeIcon icon={faPlus} style={styles.icon3}/></button>
                    </div>
        ...
        <div className='dropdown'>
            {
                items.map((obj)=>{
                    return(
                        <div>
                            <DropdownItem src={obj.src} name={obj.name} price={obj.price} key={obj.name} quantity={obj.quantity}/>
            ...
            <div className='checkout-btn'>
                ...
                <a className='check-btn' href="/checkout/*">Go to chcekout</a>
            </div>
